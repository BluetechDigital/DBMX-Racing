...
> = ({
	...
	return (
		<>
			<Html>
				<Head />
				<Preview>Thank You for Contacting DBMX Racing</Preview>
				<Body style={main}>
					<Container style={container}>
						<EmailHeader
							imagesDirUrl={`${imagesDirUrl}/02/dbmx-racing-Email-Header-Customer.png`}
						/>
						<Section style={content}>
							<Text style={introParagraph}>Hi {firstName},</Text>
							<Text style={paragraph}>
								Thank you for reaching out to DBMX Racing regarding {subject}{" "}
								and our {selectedServices} services. We have received your
								website inquiry on {formattedDate} and are eager to assist you
								with your goals. At this moment there is no further action is
								required from you.
							</Text>
							<Text style={paragraph}>
							...
							<Text style={paragraph}>
								Thank you once again for considering DBMX Racing for your{" "}
								{selectedServices} needs. We look forward to the opportunity to
							...
							<Text style={paragraph}>
								...
								<br />
								Website:{" "}
								<Link style={link} href={`https://www.dirtboxmx.com`}>
									dirtboxmx.com
								</Link>
							</Text>
						</Section>
