				...
				>
					...
					>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 mr-2 text-xs leading-none text-white transition-all duration-500 ease-in-out bg-primary-default hover:bg-accent-dark"
						>
							Accept Cookies
						</motion.button>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 text-xs leading-none text-white bg-primary-dark hover:bg-primary-darkerTwo"
						>
							Refuse Cookies
						</motion.button>
					</motion.div>
