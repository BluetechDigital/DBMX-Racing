				...
				<div className="px-4 lg:px-0 overflow-x-hidden">
					<div className="py-0 lg:py-10 pl-3/20">
						<div className="hidden lg:flex w-full mr-0 items-center justify-end gap-8">
							...
							>
								<span className="block w-full h-[50px] bg-primary-default p-2 hover:bg-primary-dark transition-all ease-in-out duration-500">
									<svg
										width="800px"
										height="800px"
										viewBox="0 0 24 24"
						...
						<div className="flex lg:hidden w-full mr-0 items-center justify-center gap-8">
							{/* Prev */}
							<motion.button
								initial={{opacity: 0}}
								animate={{opacity: 1}}
