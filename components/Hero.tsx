...
const Hero: FC<IHero> = ({
	...
	return (
		<>
			<div
				className="bg-white pt-28 h-full lg:h-[75vh] relative lg:mt-2 bg-center bg-no-repeat bg-cover overflow-hidden"
			...
			>
				...
				<div className="h-full relative z-10 flex flex-col xl:flex-row bg-pureBlack/50 lg:bg-pureBlack/20 overflow-hidden">
