		...
		<>
			<div className="bg-white pt-28">
				...
				>
					...
					<div className="min-h-full xl:min-h-[75vh] relative z-10 h-full flex flex-col xl:flex-row">
						<div className="lg:container py-20 xl:py-0 mx-auto">
							<div className="h-full flex flex-col items-baseline justify-center px-4 xl:px-0">
								...
								<div className="xl:max-w-2xl">
									<Paragraph
										content={paragraph}
										tailwindStyling="mb-6 text-white leading-[1.75rem] font-normal font-NeoGramTrial text-xl text-center xl:text-left"
									/>
									<motion.div
										initial={initial}
										variants={stagger}
