		...
		<>
			<div className="bg-white">
				<div className="container px-4 mx-auto">
					...
					>
						<h2 className="text-black flex items-center justify-center gap-4 text-center tracking-normal leading-normal sm:leading-[2.75rem] font-[600] mb-4 sm:mb-10 text-lg sm:text-3xl md:text-4xl">
							{title}
						</h2>
