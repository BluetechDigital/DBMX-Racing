...
export const getAllPreviewPagesFlexibleContentComponents = async (
	...
	try {
		...
		console.log(error);
		throw new Error(
			"Something went wrong trying to get all preview pages flexible content components"
		);
	}
};
...
export const getAllPreviewPostsFlexibleContentComponents = async (
	...
	try {
		...
		console.log(error);
		throw new Error(
			"Something went wrong trying to get all preview posts flexible content components"
		);
	}
};
